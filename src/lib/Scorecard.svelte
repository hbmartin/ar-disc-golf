<script lang="ts">
import { formatScoreVsPar, totalPar, totalStrokes } from "./gameState.ts";
...
const parTotal = $derived(totalPar(session.course));
</script>
...
<div class="scorecard">
	<table>
		...
		<tbody>
			{#each session.course.holes as hole, i (hole.number)}
				<tr
